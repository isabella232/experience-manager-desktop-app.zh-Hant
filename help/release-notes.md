...
最新案頭應用程式2.2.2版的發行資訊如下。 發行日期為2023年3月09日。

最新版本的案頭應用程式包含下列錯誤修正：

* [僅Windows] 安裝2.2.0和2.2.1版本後，案頭應用程式會顯示空白畫面。
...
* [!DNL Experience Manager] 已擷取XMP記錄，以及資產中繼資料記錄的路徑。
...
* 當您上傳包含中文字元的資料夾(ASSETS-9237)中的檔案時，案頭應用程式會停止回應。

* 案頭應用程式會在檔案名稱中以破折號取代點(ASSETS-10955)。
